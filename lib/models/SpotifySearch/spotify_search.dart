...
//
//     final spotifySearch = spotifySearchFromJson(jsonString);
...
String spotifySearchToJson(SpotifySearch data) => json.encode(data.toJson());
...
class SpotifySearch {
  ...
  factory SpotifySearch.fromJson(Map<String, dynamic> json) => SpotifySearch(
